...
function post(){
    ...
    defenders.innerHTML += "&nbsp;&nbsp;&nbsp; <span id='agent1_1' style='font-weight:bold; font-size:30px' contentEditable='true'>" + name1_1 + "</span>"
    ...
    defenders.innerHTML += "&nbsp;&nbsp;&nbsp; <span id='agent1_2' style='font-weight:bold; font-size:30px' contentEditable='true'>" + name1_2 + "</span>"
    ...
    defenders.innerHTML += "&nbsp;&nbsp;&nbsp; <span id='agent1_3' style='font-weight:bold; font-size:30px' contentEditable='true'>" + name1_3 + "</span>"
    ...
    defenders.innerHTML += "&nbsp;&nbsp;&nbsp; <span id='agent1_4' style='font-weight:bold; font-size:30px' contentEditable='true'>" + name1_4 + "</span>"
    ...
    defenders.innerHTML += "&nbsp;&nbsp;&nbsp; <span id='agent1_5' style='font-weight:bold; font-size:30px' contentEditable='true'>" + name1_5 + "</span>"
    ...
    attackers.innerHTML += "&nbsp;&nbsp;&nbsp; <span id='agent2_1' style='font-weight:bold; font-size:30px' contentEditable='true'>" + name2_1 + "</span>"
    ...
    attackers.innerHTML += "&nbsp;&nbsp;&nbsp; <span id='agent2_2' style='font-weight:bold; font-size:30px' contentEditable='true'>" + name2_2 + "</span>"
    ...
    attackers.innerHTML += "&nbsp;&nbsp;&nbsp; <span id='agent2_3' style='font-weight:bold; font-size:30px' contentEditable='true'>" + name2_3 + "</span>"
    ...
    attackers.innerHTML += "&nbsp;&nbsp;&nbsp; <span id='agent2_4' style='font-weight:bold; font-size:30px' contentEditable='true'>" + name2_4 + "</span>"
    ...
    attackers.innerHTML += "&nbsp;&nbsp;&nbsp; <span id='agent2_5' style='font-weight:bold; font-size:30px' contentEditable='true'>" + name2_5 + "</span>"
    ...
    attackers.innerHTML += "<span id='attacker-name' style='font-weight:bold; font-size:40px' contentEditable='true'>" + attackers_name + "</span>"
    ...
    defenders.innerHTML += "<span id='defender-name' style='font-weight:bold; font-size:40px' contentEditable='true'>" + defenders_name + "</span>"
